                ...
                <?php
                    ...
                    if( $myposts ){
                    	foreach( $myposts as $post ){
                    		setup_postdata( $post );
                    ?>
                    <img src="<?php the_post_thumbnail_url() ?>" alt="Картинка поста" class="post-thumb">
                    <?php $author_id = get_the_author_meta('ID'); ?>
                    <a href="<?php echo get_author_posts_url($author_id); ?>" class="author">
                        <img src="<?php echo get_avatar_url($author_id); ?>" alt="Аватар" class="avatar">
                ...
                switch ($cnt) {
                            ...
                            <a href="<?php the_permalink(); ?>" class="article-grid-permalink">
                                ...
                                <div class="article-grid-info">
                                    <div class="article-grid-author">
                                        <?php $author_id = get_the_author_meta('ID'); ?>
                                        <img class="article-grid-avatar" src="<?php echo get_avatar_url($author_id); ?>" alt="Аватар автора">
                    ...
                    case '2': ?>
                        <li class="article-grid-item article-grid-item-2">
                            <img class="article-grid-thumb" src="<?php the_post_thumbnail_url(); ?>" alt="Карточка поста">
                            <a href="<?php the_permalink(); ?>" class="article-grid-permalink">
                                    ...
                                    <div class="author">
                                        ...
                                        <div class="author-info">
                                            ...
                                            <div class="author-info-comments">
                                                ...
                                                <img class="likes-icon" src="<?php echo get_template_directory_uri() . '/assets/images/heart.svg'?>" alt="Иконка сердечко">
                    ...
                    case '3': ?>
                        ...
                        <li class="article-grid-item article-grid-item-3">
                            <a href="<?php the_permalink(); ?>" class="article-grid-permalink">
                                ...
                                <img class="article-thumb" src="<?php the_post_thumbnail_url();?>" alt="Картинка поста">
